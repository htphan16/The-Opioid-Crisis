...
def SCCorrelation(State, SQuery, CQuery, YYYY, Title, Show = True): # YYYY is list of years
    ...
    for Year in YYYY:
        ...
        for values in SValues:
            SResiduals.append(values-mean(SValues))
        slope, intercept, r_value, p_value, std_err = stats.linregress(x=CValues,y=SValues)
        print(slope, intercept, r_value, p_value, std_err)
        '''plt.plot(CValues, SResiduals, 'o', label = '%s'%(Year))
...
print(SCCorrelation('OH', ['Fentanyl'], ['HC01_VC88'], [str(i) for i in range(2010, 2017)], 'OH-F-residuals.png', Show = True))
print(SCCorrelation('PA', ['Fentanyl'], ['HC01_VC88'], [str(i) for i in range(2010, 2017)], 'PA-F-residuals.png', Show = True))
print(SCCorrelation('KY', ['Fentanyl'], ['HC01_VC88'], [str(i) for i in range(2010, 2017)], 'KY-F-residuals.png', Show = True))
print(SCCorrelation('VA', ['Fentanyl'], ['HC01_VC88'], [str(i) for i in range(2010, 2017)], 'VA-F-residuals.png', Show = True))
print(SCCorrelation('WV', ['Fentanyl'], ['HC01_VC88'], [str(i) for i in range(2010, 2017)], 'WV-F-residuals.png', Show = True))

print(SCCorrelation('OH', ['Fentanyl'], ['HC01_VC86'], [str(i) for i in range(2010, 2017)], 'OH-F-residuals.png', Show = True))
print(SCCorrelation('PA', ['Fentanyl'], ['HC01_VC86'], [str(i) for i in range(2010, 2017)], 'PA-F-residuals.png', Show = True))
print(SCCorrelation('KY', ['Fentanyl'], ['HC01_VC86'], [str(i) for i in range(2010, 2017)], 'KY-F-residuals.png', Show = True))
print(SCCorrelation('VA', ['Fentanyl'], ['HC01_VC86'], [str(i) for i in range(2010, 2017)], 'VA-F-residuals.png', Show = True))
print(SCCorrelation('WV', ['Fentanyl'], ['HC01_VC86'], [str(i) for i in range(2010, 2017)], 'WV-F-residuals.png', Show = True))


#rint(SCCorrelation('KY', ['Heroin'], ['HC01_VC03'], [str(i) for i in range(2010, 2017)], 'KY-H-residuals.png', Show = True))
#print(SCCorrelation('OH', ['Heroin'], ['HC01_VC03'], [str(i) for i in range(2010, 2017)], 'OH-H-residuals.png', Show = True))
#print(SCCorrelation('PA', ['Heroin'], ['HC01_VC03'], [str(i) for i in range(2010, 2017)], 'PA-H-residuals.png', Show = True))
#print(SCCorrelation('VA', ['Heroin'], ['HC01_VC03'], [str(i) for i in range(2010, 2017)], 'VA-H-residuals.png', Show = True))
#print(SCCorrelation('WV', ['Heroin'], ['HC01_VC03'], [str(i) for i in range(2010, 2017)], 'WV-H-residuals.png', Show = True))
